  ...
  describe "Exercise Category creation" do
  	...
  	describe "with invalid information" do
  		...
  		it "should not create a micropost" do
  			expect { click_button "Add" }.not_to change(ExerciseCategory, :count)
  		end
  	...
  	describe "with valid information" do
  		...
  		before { fill_in 'exercise_category_name', with: "Lorem ipsum" }
  		it "should create Exercise Category" do
  			expect { click_button "Add" }.to change(ExerciseCategory, :count).by(1)
  		end
  	end
    ...
    describe "Exercise Category destruction" do
      ...
      describe "as correct user" do
        ...
        it "should delete a exercise_category" do
          expect { click_link "delete" }.to change(ExerciseCategory, :count).by(-1)
        end
      end
    end
  end
